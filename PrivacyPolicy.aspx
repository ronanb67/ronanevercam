...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="jumbotron">
        ...
        LEGALLY BOUND BY THIS LICENCE AGREEMENT.
            ...
            <p>PLEASE READ THIS LICENCE AGREEMENT CAREFULLY.</p>
            <p>
                This End User Licence Agreement (“Agreement”) is a binding legal agreement between Evercam Limited, with company number 490988 and whose registered office is at 12, Parnell Square East, Dublin, Co. Dublin 
        and You (being the customer identified below) pursuant to which You are provided with a licence to use the Evercam service, in accordance with the provisions of this Agreement and the Service 
        ...
        materials made available to You by Evercam, including but not limited to Evercam’s privacy and security policies which You acknowledge having reviewed.
            </p>
            <br />
            <h4>1. Definitions</h4>
        ...
        Agreement, may be updated by Evercam from time to time in its sole discretion;
            ...
            <p>
                2.1. You agree that because the Service is a hosted, online application, Evercam and its distributors may occasionally need to notify all users of the Service of important announcements regarding
                 the operation of the Service, whether or not they have opted out of email notifications.
            </p><br />
            <h4>3.Licence Grant & Restrictions</h4>
            <p>
                3.1. In consideration of You paying the applicable charges and fees as set out in clause 8 and agreeing to abide by the terms of and conditions of this Agreement Evercam hereby grants to You a 
                non-exclusive, non-transferable, royalty free worldwide right to access and use the Service for the Term, solely for Your own internal business and private purposes, subject to the terms and 
            ...
            <p>
                3.4. User licenses cannot be shared or used by more than one individual User but may, [with the prior written consent of Evercam] be reassigned from time to time a new user who is replacing a 
            ...
            <p>
                3.7. You may use the Service only for Your internal business and private purposes and You shall not: (i) download, distribute, store or use content that is not Yours or that You do not have the 
                legal right to view or use; (ii) send or store infringing, obscene, threatening, libellous, or otherwise unlawful data, including material which violates any third party privacy rights; (iii) 
                ...
                performance of the Service or the data contained therein; or (v) attempt to gain unauthorized access to the Service or its related systems or networks.
            </p><br />
            <h4>4. Your responsibilities</h4>
            <p>
                4.1. You are responsible for all activity occurring under Your User accounts and shall abide by all applicable local, provincial or state, national and foreign laws, treaties and regulations in
                 connection with Your use of the Service, including those related to data protection and privacy, and the transmission of technical or personal data.
            </p><br />
            <p>
                4.2. You shall: (i) notify Evercam immediately of any unauthorised use of any password or account or any other known or suspected breach of security; (ii) report to Evercam immediately and use 
                reasonable efforts to stop immediately any copying or distribution of Content by You or Your Users; and (iii) not impersonate another User or provide false identity information to gain access to 
                or use the Service.
            </p><br />
            <h4>5. Account Information and Data</h4>
            <p>
                5.1. You agree that Evercam does not own any data, information or material that You submit to the Service in the course of using the Service (“Customer Data”).
            </p><br />
            <p>
                5.2. You agree that You, not Evercam, shall have sole responsibility for the accuracy, quality, integrity, legality, reliability, appropriateness, and intellectual property ownership or right 
                to use of all Customer Data, and Evercam shall not be responsible or liable for the deletion, correction, destruction, damage, loss or failure to store any Customer Data.
            </p><br />
            <p>
                5.3. Evercam shall have the right to withhold, remove and/or discard Customer Data without notice for any breach, including, without limitation, Your non-payment. Upon termination of this 
                Agreement by Evercam as a result of Your breach, Your right to access or use Customer Data immediately ceases, and Evercam shall have no obligation to maintain or forward any Customer Data.
            </p><br />
            <h4>6.Intellectual Property Rights</h4>
            <p>You agree that Evercam alone (and/or its licensors, where applicable) owns all right, title and interest, including all intellectual property rights, in and to the Evercam Technology and Content 
                or arising out of or in connection with the Service and any suggestions, ideas, enhancement requests, feedback, recommendations or other information provided by You or any other party relating to 
                the Service.</p><br />
            <p>
            ...
            <h4>7. Third Party Interactions</h4>
            <p>
                7.1. Evercam and its licensors shall have no liability, obligation or responsibility for any data exchange, correspondence, or interaction between You and any third-party in relation to the 
            ...
            <p>
                9.2. Evercam shall process the Personal Data only on and subject to Your instructions from time to time and shall not process the Data for any other purpose. Evercam shall implement and maintain appropriate technical and organisational security measures against unauthorised 
            ...
            <p>
                ...
                claim by a data subject/individual or any investigation by the Office of the Data Protection Commissioner in respect of the processing of the Personal Data by Evercam.
            </p><br />
            <p>
...
<p>(c)You must immediately pay any sums due to Evercam under this Agreement.</p> 
            ...
            <p>
                ...
                threatened claim arising from the breach by You or Your Users of this Agreement, provided in any such case that Evercam (a) gives written notice of the claim promptly to You; (b) gives You sole 
                control of the defense and settlement of the claim (provided that You may not settle or defend any claim unless You unconditionally release Evercam of all liability and such settlement does not 
