...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container" style="margin-left:-25px">
        ...
        <p>
            Our online ordering system uses a cookie to record a unique reference on your computing device so that we can keep track of your order as you use the system. 
            This cookie, that’s saved to your system, is only valid for a single visit and each new visit will result in a new cookie overwriting any previous records that were generated on 
            previous visits to our site.
        </p>
        <p>If your internet browser is set to reject cookies or if your network firewall won’t allow them then unfortunately you won’t be able to use our online service.</p>
        <p>
            Please refer to your internet browser’s help section to see how to enable cookies on your computing device. In order that we can monitor and improve the site we may gather certain information 
            about you when you use it, including details of your domain name and IP address, operating system, browser, version and the website that you visited prior to our site. This may involve the 
            use of a cookie that will not expire at the end of your browsing session.
        </p>
        <h3><a name="changes"></a>Changes</h3>
        <p>If we decide to change our Terms and Conditions, we’ll post the changes on this page so that you’re always aware of what information we collect, how we use it and under what circumstances we disclose it.</p>
        <h3><a name="ordering"></a>Ordering</h3>
        <p>
            When placing an order you agree that all the information given is accurate and complete. You will receive an acknowledgement email confirming receipt of your order and an Order ID: this 
            email will only be an acknowledgement and will not constitute acceptance of your order.
        </p>
        <p>
            By placing an order, you make an offer to us to purchase the products you have selected. We may or may not 
            accept your offer at our discretion. If we cannot accept your order we will contact you by email and shall refund any amount already paid to us. We will always make every effort to supply you 
