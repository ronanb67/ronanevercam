...
var App = function () {
    ...
    var handlePortletTools = function () {
        ...
        jQuery('body').on('click', '.portlet > .portlet-title > .tools > a.reload', function (e) {
            ...
            //dan@kco.ie: generic function call for every page that uses this feature
            reloadData();
        ...
        /* dan@kco.ie: customising dropdown function */
        jQuery('body').on('click', '.portlet > .portlet-title > .tools > .btn-group > ul > li > a.reload', function (e) {
            e.preventDefault();
            var el = jQuery(this).closest(".portlet").children(".portlet-body");
            App.blockUI(el);
